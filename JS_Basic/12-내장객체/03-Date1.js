...
console.log(date1.toLocaleString('de-DE'));//독일
console.log(date1.toLocaleString('ko-KO'));


// Date의 날짜부분을 나타내는 문자열을 시스템에 설정된 현재 지역의 형식으로 반환
console.log(date1.toLocaleDateString());
console.log(date1.toLocaleDateString('de-DE'));//독일
console.log(date1.toLocaleDateString('ko-KO'));

// Date의 시간 부분을 나타내는 문자열을 시스템에 설정된 현재 지역의 형식으로 반환
console.log(date1.toLocaleTimeString());
console.log(date1.toLocaleTimeString('de-DE'));//독일
console.log(date1.toLocaleTimeString('ko-KO'));
